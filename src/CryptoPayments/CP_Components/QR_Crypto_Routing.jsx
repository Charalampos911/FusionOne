...
function QR_Crypto_Routing({ orderId, SuccessAndBack }) {
  const Api = useSelector((state) => state.Api); 
  const dispatch = useDispatch(); 
const targetUrl = `${window.location.origin}${import.meta.env.BASE_URL}payOrderWithCrypto/${orderId}`;
...
export default QR_Crypto_Routing;