...
function QR_Crypto_Routing_Perma({ PermaProductTransactionId, SuccessAndBack }) {
  const Api = useSelector((state) => state.Api); 
  const dispatch = useDispatch(); 
  const targetUrl = `${window.location.origin}${import.meta.env.BASE_URL}/payOrderWithCryptoPerma/${PermaProductTransactionId}`;
...
export default QR_Crypto_Routing_Perma;