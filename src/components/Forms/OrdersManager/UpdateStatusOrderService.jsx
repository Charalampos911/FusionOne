...
export default function UpdateStatusOrderService({ServiceStatuses,OrderService,Services,SelectedOrder,ChangeSelection}) { 
...
console.log("ServiceStatuses===",ServiceStatuses)
      ...
      .then((ResponseB) => {
        ...
        // 2. Filter ServiceStatuses
        // 'item' represents an array like ['InProgress', 1]. item[1] gets the number 1.
        const filteredStatuses = ServiceStatuses.filter(item => 
