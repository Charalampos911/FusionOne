...
export default function Creator(props) { 
  ...
  // 1. Fetch available margins (same as Editor)
  useEffect(() => {
    dispatch(
      apiRequest({
        name: "EmployeeWorkDaysSchedulerCreator.jsx | useEffect",
    ...
    .unwrap()
    .then((data) => {
      // Generate 15-minute intervals spanning the entire expanded block
  ...
  const HCreate = () => {
    ...
    dispatch(
      apiRequest({
        name: "EmployeeWorkDaysSchedulerCreator.jsx | HCreate",
        url: "api/EmployeeWorkDays/SCreate",
        method: "POST",
        body: {
