...
export default function Creator(props) { 
  ...
  // Fetch available margins dynamically
  useEffect(() => {
    if (!Seg?.StartDate) return;

    dispatch(
      apiRequest({
        name: "SpecialOperationsDaysSchedulerCreator.jsx | useEffect",
  ...
  const HCreate = () => {
    ...
    dispatch(
      apiRequest({
        name: "SpecialOperationsDaysSchedulerCreator.jsx | HCreate",
        url: "api/SpecialOperationsDays/SCreate",
        method: "POST",
        body: {
  ...
  return (
    <div id="DateTimeEditor" className="Operations">
      <div className='Operations-head'>     
        ...
        <label>Special Operations Days Creator</label>
      </div>
