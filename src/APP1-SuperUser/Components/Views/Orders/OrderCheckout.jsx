...
export default function OrderCheckout({SelectedOrder,AfterCheckout }) { 
    ...
    {PaymentMethod==1?
      <div className='CheckoutBox Cash'>
        ...
        <div className='Checkout-btn'>
          <FormButton text={"Complete checkout"} onClick={()=>HCheckOutCash(SelectedOrder.Id,dispatch,apiRequest,setCheckoutSuccess)}/>
      ...
      {PaymentMethod==2?
         <QR_Viva_Routing orderId={SelectedOrder.Id} SuccessAndBack={()=>AfterCheckout()}/>
      :null}
      {PaymentMethod==3?
        <QR_Crypto_Routing orderId={SelectedOrder.Id} SuccessAndBack={()=>AfterCheckout()}/>
      :null}
    </>
    :
...
const HCheckOutCash =(SelectedOrder,dispatch,apiRequest,setCheckoutSuccess)=>{
    dispatch(
    apiRequest({
      name: "OrderCheckout.jsx | CheckOutCashSU",
      url: "api/Orders/CheckOutCashSU",
      method: "POST",
      body: {
