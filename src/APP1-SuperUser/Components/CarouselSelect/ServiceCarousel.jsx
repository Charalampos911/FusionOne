...
export const ServiceCarousel = ({ services = [], onSelect,  search,
  categories,
  category, }) => {
  const Api = useSelector((state) => state.Api);
  const dispatch = useDispatch();

  // Store current active image index per card: { [itemId]: imageIndex }
  ...
  const handleNextImage = (e, itemId, totalImages) => {
    e.stopPropagation(); // Prevents triggering service selection
