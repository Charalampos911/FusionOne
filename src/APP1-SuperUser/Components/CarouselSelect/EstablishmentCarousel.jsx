...
export const EstablishmentCarousel = ({
  establishments = [],
  selectedOnlineCode,
  onSelect,
}) => {
  ...
  // Lightbox modal state: null or { item: establishmentObject, index: number }
  ...
  return (
    <div className="org-gallery-container">
      <h2 className="org-gallery-title">ESTABLISHMENTS</h2>

      <div className="org-grid">
        {establishments?.map((item) => {
          const isSelected = selectedOnlineCode === item.OnlineCode;
