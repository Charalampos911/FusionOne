...
export const ProductCarousel = ({ Products = [], onSelect }) => {
  ...
  // Lightbox modal state: null or { item: productObject, index: number }
  const [lightboxState, setLightboxState] = useState(null);

  // Card image navigation handlers
  const handleNextImage = (e, orgCode, totalImages) => {
    e.stopPropagation(); // Prevents triggering product selection
  ...
  return (
    <div className="org-gallery-container">
      {/* <h2 className="org-gallery-title">FusionOne Products</h2> */}
